...
public class ModItems {
    ...
    public static final List<String> VALID_MODELS = Arrays.asList("amethyst_armor", "torch_armor");
    ...
    public static final Item RAPTOR_SPAWN_EGG = registerItem("raptor_spawn_egg",
    ...
    public static final Item CUSTOM_CHESTPLATE = registerItem("custom_chestplate",
            new DynamicArmorItem(ModArmorMaterials.CUSTOM, ArmorItem.Type.CHESTPLATE, new FabricItemSettings()));
    public static final Item CUSTOM_LEGGINGS = registerItem("custom_leggings",
            new DynamicArmorItem(ModArmorMaterials.CUSTOM, ArmorItem.Type.LEGGINGS, new FabricItemSettings()));
    public static final Item CUSTOM_BOOTS = registerItem("custom_boots",
            new DynamicArmorItem(ModArmorMaterials.CUSTOM, ArmorItem.Type.BOOTS, new FabricItemSettings()));
    ...
    public static void registerModItems() {
        CoffeeHouse.LOGGER.info("Registering Mod Items for " + CoffeeHouse.MOD_ID);
    }
}
